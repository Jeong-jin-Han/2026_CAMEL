---
title: Hypotheses
aliases: [Hypotheses, 연구 가설, Research Hypotheses]
tags: [meta/hub]
---
# 연구 가설 (Working Hypotheses)

> [!warning] 이 폴더의 성격
> **검증 전 working hypothesis** 모음 — *"무엇을 풀고 싶나"*의 기록. `concepts/`(객관 배경)·`papers/`(논문)와 **별개**. 여기 적힌 건 사실이 아니라 *본인 연구 사고*이며, 1년 뒤 데이터로 정정될 수 있음.
